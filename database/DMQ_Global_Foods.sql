...
-- Customers
-- create 
INSERT INTO Customers (customerID, currentAddress, firstName, lastName, email, phoneNumber)
VALUES (:ID, :web_supplied_AddrID, :web_supplied_fname, :web_supplied_lname, :web_supplied_email, :web_supplied_phone);
-- delete
...
-- Orders
-- create
INSERT INTO Orders (orderID, customerID, orderProgress, totalPrice, orderDate)
VALUES    (;ID, :web_supplied_customerID, ;web_supplied_progress , :web_supplied_price, :web_supplied_date);
-- delete
...
-- OrderItems
-- create
INSERT INTO OrderItems (orderID, foodID, quantity, totalPrice)
VALUES    (:web_supplied_OrderID, :web_supplied_foodID, :web_supplied_quantity, :web_supplied_totalPrice);
-- delete
...
-- Foods
-- create
INSERT INTO Foods (foodID, foodName, foodDescription, foodCategory, calories, cuisine, price)
VALUES (:web_supplied_foodID, :web_supplied_foodName, :web_supplied_foodDesc, :web_supplied_foodCategory, :web_supplied_foodCalory, :web_supplied_cuisine, :web_supplied_price);
...
-- Addresses
-- create
INSERT INTO Addresses (addressID, city, streetName, streetNumber)
VALUES (:web_supplied_addressId, :web_supplied_city, :web_supplied_streetName, :web_supplied_streetNumber);
